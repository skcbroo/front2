...
<div className="mt-10 max-w-4xl mx-auto">
  ...
  Para efeito de comparação com o CDI, consideramos uma taxa Selic anual de <strong>15% a.a.</strong>, que reflete o cenário econômico vigente. Esse valor serve como referência de retorno de aplicações tradicionais e ajuda a avaliar a atratividade dos créditos judiciais. Tanto o <strong>retorno projetado</strong> quanto a <strong>data estimada de recebimento</strong> são previsões que podem sofrer alterações conforme o andamento do processo judicial podendo ser antecipadas, postergadas ou até resultar em valores diferentes do inicialmente previsto.
