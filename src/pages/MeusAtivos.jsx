...
<div className="mt-10 max-w-4xl mx-auto">
  ...
  Para efeito de comparação com o CDI, consideramos uma taxa Selic anual de <strong>15% a.a.</strong>, que reflete o cenário econômico vigente. Esse valor serve como referência de retorno de aplicações tradicionais e ajuda a avaliar a atratividade dos créditos judiciais.  O <strong>retorno projetado</strong> é uma estimativa, que pode sofrer alterações conforme o andamento do processo judicial, podendo ser superior ou inferior ao previsto inicialmente.
